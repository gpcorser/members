...
function send_mail_plain(string $toEmail, string $subject, string $body): bool
{
    ...
    try {
        // Use PHP's built-in mail() transport by default.
        // On many shared hosts, sendmail may be unavailable or configured in a way
        // that makes PHPMailer->isSendmail() fail while native mail() succeeds.
        $mail->isMail();
        ...
        // Log both the exception message and PHPMailer ErrorInfo to help diagnose
        // hosting/provider-specific mail transport issues.
